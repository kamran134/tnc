...
export async function PATCH(
  ...
  try {
    ...
    console.log(`🔐 [Admin Core Value Activate API] PATCH request for ID: ${id}`);
    ...
    const backendUrl = `${BACKEND_URL}/api/admin/core-values/${id}/activate`;
    ...
    console.log('✅ Core value activated successfully');
