...
export default function ServicesPage() {
  ...
  // Reset to first page when search term changes - use useMemo instead of useEffect
  const effectivePage = useMemo(() => {
    return debouncedSearchTerm ? 0 : currentPage;
  }, [debouncedSearchTerm, currentPage]);

  const { data: servicesData, isLoading, isFetching } = useAdminServicesListQuery({ 
    page: effectivePage, 
    size: pageSize,
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Global Order</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Category Order</th>
