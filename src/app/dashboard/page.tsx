      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Manage company mission, vision, and contact details</p>
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Manage team members, positions, and profiles</p>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">About Sections</h3>
            </div>
            <p className="text-gray-600 mb-4">Manage Haqqımızda page content, sections, and images</p>
            <div className="flex items-center text-sm text-amber-600 font-medium">
              <span>Manage About Sections</span>
              <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
